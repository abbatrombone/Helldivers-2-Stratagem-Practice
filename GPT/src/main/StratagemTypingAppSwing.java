...
public class StratagemTypingAppSwing extends JFrame {
    /*
    Prommpt: Use javax.swing.* to make the app
     */
    ...
    public StratagemTypingAppSwing() {
        // Frame settings
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new Runnable() {
            @Override
            public void run() {
                StratagemTypingAppSwing app = new StratagemTypingAppSwing();
                app.setVisible(true);
            }
        });
    }
