...
public class StratagemTypingPracticeApp11 {
    /*
    Prompt:
      Timer did fix and codes work now, thank you. There are still several methods that are not defined or are not working
    loadSettings()
    saveSettings()
    openKeybindSettings()
    changeColor()
    ...
    NOTES:
    Keybinds stopped working
    Jlabel timer text size does not update with other text sizes
     */
    ...
    public StratagemTypingPracticeApp11() {
    ...
    private void openKeybindSettings() {
        JOptionPane.showMessageDialog(frame, "Keybind settings are not implemented yet.");
    }
    ...
    private void changeTextSize() {
        ...
        if (sizeStr != null && sizeStr.matches("\\d+")) {
            ...
            promptLabel.setFont(new Font("Arial", Font.PLAIN, Integer.parseInt(sizeStr)));
            saveSettings();
        }
    }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(StratagemTypingPracticeApp11::new);
    }
}
