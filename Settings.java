...
public class Settings extends JFrame {
    ...
    private void initComponents() {
        ...
        up_label.setBackground(boxcolor);
        up_label.setFont(new Font("Segoe UI", Font.BOLD, textSize));
        up_label.setForeground(txtcolor);
        up_label.setText(up+" Key Bind");
        up_label.setBounds(142,142,700,textboxSize);

        down_label.setBackground(boxcolor);
        down_label.setFont(new Font("Segoe UI", Font.BOLD, textSize));
        down_label.setForeground(txtcolor);
        down_label.setText(down+" Key Bind");
        down_label.setBounds(142,142,700,textboxSize);

        left_label.setBackground(boxcolor);
        left_label.setFont(new Font("Segoe UI", Font.BOLD, textSize));
        left_label.setForeground(txtcolor);
        left_label.setText(left+" Key Bind");
        left_label.setBounds(142,142,700,textboxSize);

        right_label.setBackground(new Color(255, 255, 255));
        right_label.setFont(new Font("Segoe UI", Font.BOLD, textSize));
        right_label.setForeground(txtcolor);
        right_label.setText(right+" Key Bind");
        right_label.setBounds(142,142,700,textboxSize);


        up_key.setEditable(true);
        up_key.setSize(300,textboxSize);
        up_key.setFont(new Font("Segoe UI", 3, textSize));
        up_key.setForeground(txtcolor);
        up_key.setBackground(boxcolor);
        ...
        down_key.setSize(300,textboxSize);
        down_key.setFont(new Font("Segoe UI", 3, textSize));
        down_key.setForeground(txtcolor);
        down_key.setBackground(boxcolor);
        ...
        left_key.setSize(300,textboxSize);
        left_key.setFont(new Font("Segoe UI", 3, textSize));
        left_key.setForeground(txtcolor);
        left_key.setBackground(boxcolor);
        ...
        right_key.setSize(300,textboxSize);
        right_key.setFont(new Font("Segoe UI", 3, textSize));
        right_key.setForeground(txtcolor);
        right_key.setBackground(boxcolor);
                ...
                layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addComponent(up_label, GroupLayout.PREFERRED_SIZE,   300, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(down_label, GroupLayout.PREFERRED_SIZE, 300, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(left_label, GroupLayout.PREFERRED_SIZE, 300, GroupLayout.PREFERRED_SIZE)
                                        .addComponent(right_label, GroupLayout.PREFERRED_SIZE,300, GroupLayout.PREFERRED_SIZE)
                                )
                                .addGroup(layout.createParallelGroup(GroupLayout.Alignment.LEADING)
                                        .addComponent(up_key)
